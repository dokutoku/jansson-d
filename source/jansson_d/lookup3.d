...
{
	enum hashmask = "(mixin (jansson_d.lookup3.hashsize!(\"" ~ n ~ "\")) - 1)";
}
...
{
	enum mix = "{ a -= c; a ^= mixin (jansson_d.lookup3.rot!(\"" ~ c ~ "\", \"4\")); c += b; b -= a; b ^= mixin (jansson_d.lookup3.rot!(\"" ~ a ~ "\", \"6\")); a += c; c -= b; c ^= mixin (jansson_d.lookup3.rot!(\"" ~ b ~ "\", \"8\")); b += a; a -= c; a ^= mixin (jansson_d.lookup3.rot!(\"" ~ c ~ "\", \"16\")); c += b; b -= a; b ^= mixin (jansson_d.lookup3.rot!(\"" ~ a ~ "\", \"19\")); a += c; c -= b; c ^= mixin (jansson_d.lookup3.rot!(\"" ~ b ~ "\", \"4\")); b += a; }";
}
...
{
	enum final_ = "{ c ^= b; c -= mixin (jansson_d.lookup3.rot!(\"" ~ b ~ "\", \"14\")); a ^= c; a -= mixin (jansson_d.lookup3.rot!(\"" ~ c ~ "\", \"11\")); b ^= a; b -= mixin (jansson_d.lookup3.rot!(\"" ~ a ~ "\", \"25\")); c ^= b; c -= mixin (jansson_d.lookup3.rot!(\"" ~ b ~ "\", \"16\")); a ^= c; a -= mixin (jansson_d.lookup3.rot!(\"" ~ c ~ "\", \"4\")); b ^= a; b -= mixin (jansson_d.lookup3.rot!(\"" ~ a ~ "\", \"14\")); c ^= b; c -= mixin (jansson_d.lookup3.rot!(\"" ~ b ~ "\", \"24\")); }";
}
