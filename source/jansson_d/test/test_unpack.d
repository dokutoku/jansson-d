...
unittest
{
...

	{
		/* false */
		int i1 = void;
		int rv = jansson_d.pack_unpack.json_unpack(jansson_d.value.json_false(), "b", &i1);
	...
	{
		/* integer */
		jansson_d.jansson.json_t* j = jansson_d.value.json_integer(42);
		...
		int i1 = void;
		int rv = jansson_d.pack_unpack.json_unpack(j, "i", &i1);
	...
	{
		/* json_int_t */
		jansson_d.jansson.json_t* j = jansson_d.value.json_integer(5555555);
	...
	{
		/* real */
		jansson_d.jansson.json_t* j = jansson_d.value.json_real(1.7);
		...
		double f = void;
		int rv = jansson_d.pack_unpack.json_unpack(j, "f", &f);
	...
	{
		/* number */
		jansson_d.jansson.json_t* j = jansson_d.value.json_integer(12345);
	...
	{
		/* string */
		jansson_d.jansson.json_t* j = jansson_d.value.json_string("foo");
		...
		char* s = void;
		int rv = jansson_d.pack_unpack.json_unpack(j, "s", &s);
...

	{
		...
		size_t z = void;
		char* s = void;
		int rv = jansson_d.pack_unpack.json_unpack(j, "s%", &s, &z);
	...
	{
		/* empty object */
		jansson_d.jansson.json_t* j = jansson_d.value.json_object();
	...
	{
		/* empty list */
		jansson_d.jansson.json_t* j = jansson_d.value.json_array();
...

	{
		...
		int rv = jansson_d.pack_unpack.json_unpack(j, "o", &j2);
	...
	{
		/* simple object */
		jansson_d.jansson.json_t* j = jansson_d.pack_unpack.json_pack("{s:i}", &("foo\0"[0]), 42);
		...
		int i1 = void;
		int rv = jansson_d.pack_unpack.json_unpack(j, "{s:i}", &("foo\0"[0]), &i1);
	...
	{
		/* simple array */
		jansson_d.jansson.json_t* j = jansson_d.pack_unpack.json_pack("[iii]", 1, 2, 3);
		...
		int i2 = void;
		int i3 = void;
		int rv = jansson_d.pack_unpack.json_unpack(j, "[i,i,i]", &i1, &i2, &i3);
...

	{
		...
		jansson_d.jansson.json_t* j = jansson_d.pack_unpack.json_pack("{s:i, s:i, s:i}", &("a\0"[0]), 1, &("b\0"[0]), 2, &("c\0"[0]), 3);
		...
		int i2 = void;
		int i3 = void;
		int rv = jansson_d.pack_unpack.json_unpack(j, "{s:i, s:i, s:i}", &("a\0"[0]), &i1, &("b\0"[0]), &i2, &("c\0"[0]), &i3);
...

	{
		...
		jansson_d.jansson.json_t* j = jansson_d.pack_unpack.json_pack("[]");
...

	{
		...
		jansson_d.jansson.json_t* j = jansson_d.pack_unpack.json_pack("[i]", 42);
	...
	{
		/* null string pointer */
		jansson_d.jansson.json_t* j = jansson_d.value.json_string("foobie");
...

	{
		/* invalid types */
		jansson_d.jansson.json_t* j = jansson_d.value.json_integer(42);
		jansson_d.jansson.json_t* j2 = jansson_d.value.json_string("foo");
...

	{
		...
		jansson_d.jansson.json_t* j = jansson_d.pack_unpack.json_pack("[i]", 1);
	...
	{
		/* null object key */
		jansson_d.jansson.json_t* j = jansson_d.pack_unpack.json_pack("{si}", &("foo\0"[0]), 42);
	...
	{
		{
			...
			int i2 = void;
			int i3 = void;
			int rv = jansson_d.pack_unpack.json_unpack(j, "[iii!]", &i1, &i2, &i3);
	...
	{
		jansson_d.jansson.json_t* j = jansson_d.pack_unpack.json_pack("{s:s, s:i}", &("foo\0"[0]), &("bar\0"[0]), &("baz\0"[0]), 42);
		char* s = void;
		int i1 = void;
		int rv = jansson_d.pack_unpack.json_unpack(j, "{sssi!}", &("foo\0"[0]), &s, &("baz\0"[0]), &i1);
...

	{
		...
		jansson_d.jansson.json_t* j = jansson_d.pack_unpack.json_pack("{s:s, s:i, s:b}", &("foo\0"[0]), &("bar\0"[0]), &("baz\0"[0]), 42, &("quux\0"[0]), 1);
	...
	{
		jansson_d.jansson.json_t* j = jansson_d.pack_unpack.json_pack("[i,{s:i,s:n},[i,i]]", 1, &("foo\0"[0]), 2, &("bar\0"[0]), 3, 4);
	...
	{
		/* ! and * must be last */
		jansson_d.jansson.json_t* j = jansson_d.pack_unpack.json_pack("[ii]", 1, 2);
	...
	{
		jansson_d.jansson.json_t* j = jansson_d.pack_unpack.json_pack("{sssi}", &("foo\0"[0]), &("bar\0"[0]), &("baz\0"[0]), 42);
...

	{
		...
		jansson_d.jansson.json_t* j = jansson_d.pack_unpack.json_pack("{s{snsn}}", &("foo\0"[0]), &("bar\0"[0]), &("baz\0"[0]));
	...
	{
		jansson_d.jansson.json_t* j = jansson_d.pack_unpack.json_pack("{s{si}}", &("foo\0"[0]), &("bar\0"[0]), 42);
...

	{
		...
		jansson_d.jansson.json_t* j = jansson_d.pack_unpack.json_pack("{sisi}", &("foo\0"[0]), 42, &("baz\0"[0]), 43);
