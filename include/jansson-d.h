...
{
	if ((json != NULL) && (json->refcount != (size_t)(-1))) {
...
{
	if ((json != NULL) && (json->refcount != (size_t)(-1)) &&( JSON_INTERNAL_DECREF(json) == 0)) {
		json_delete(json);
	}
}
...
int32_t json_array_set_new(json_t* array, size_t index, json_t* value);
int32_t json_array_append_new(json_t* array, json_t* value);
int32_t json_array_insert_new(json_t* array, size_t index, json_t* value);
int32_t json_array_remove(json_t* array, size_t index);
int32_t json_array_clear(json_t* array);
int32_t json_array_extend(json_t* array, json_t* other);

static JSON_INLINE int32_t json_array_set(json_t* array, size_t ind, json_t* value)
{
	return json_array_set_new(array, ind, json_incref(value));
}

static JSON_INLINE int32_t json_array_append(json_t* array, json_t* value)
{
	return json_array_append_new(array, json_incref(value));
}

static JSON_INLINE int32_t json_array_insert(json_t* array, size_t ind, json_t* value)
{
	return json_array_insert_new(array, ind, json_incref(value));
}

const char* json_string_value(const json_t* string_);
size_t json_string_length(const json_t* string_);
json_int_t json_integer_value(const json_t* integer);
double json_real_value(const json_t* real);
double json_number_value(const json_t* json);

int32_t json_string_set(json_t* string_, const char* value);
int32_t json_string_setn(json_t* string_, const char* value, size_t len);
int32_t json_string_set_nocheck(json_t* string_, const char* value);
int32_t json_string_setn_nocheck(json_t* string_, const char* value, size_t len);
int32_t json_integer_set(json_t* integer, json_int_t value);
int32_t json_real_set(json_t* real, double value);
...
int32_t json_unpack(json_t* root, const char* fmt, ...);
int32_t json_unpack_ex(json_t* root, json_error_t* error, size_t flags, const char* fmt, ...);
int32_t json_vunpack_ex(json_t* root, json_error_t* error, size_t flags, const char* fmt, va_list ap);
...
int32_t json_equal(const json_t* value1, const json_t* value2);
...
json_t* json_loadfd(int32_t input, size_t flags, json_error_t* error) JANSSON_ATTRS((warn_unused_result));
...
typedef int32_t (*json_dump_callback_t)(const char* buffer, size_t size, void* data);

char* json_dumps(const json_t* json, size_t flags) JANSSON_ATTRS((warn_unused_result));
size_t json_dumpb(const json_t* json, char* buffer, size_t size, size_t flags);
int32_t json_dumpf(const json_t* json, FILE* output, size_t flags);
int32_t json_dumpfd(const json_t* json, int32_t output, size_t flags);
int32_t json_dump_file(const json_t* json, const char* path, size_t flags);
int32_t json_dump_callback(const json_t* json, json_dump_callback_t callback, void* data, size_t flags);
...
int32_t jansson_version_cmp(int32_t major, int32_t minor, int32_t micro);
